...
TEST_CASE("Constructor") {
    REQUIRE(rgb_color("#6495ED").hexa() == "#6495EDFF");
    REQUIRE(rgb_color("#6495ED").hex() == "#6495ED");
    REQUIRE(rgb_color("papaya").hexa() == "#FFEFD5FF");
    REQUIRE(rgb_color("paPAya").hexa() == "#FFEFD5FF");
    REQUIRE(rgb_color(255, 239, 213, 255).hexa() == "#FFEFD5FF");
}

TEST_CASE("Mix") { REQUIRE(mix(rgb_color("#003366"), rgb_color("#d2e1dd")).hexa() == "#698AA2FF"); }
