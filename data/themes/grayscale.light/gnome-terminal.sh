...
dconf write "${profile_path}/visible-name" "'Grayscale (light) '"
dconf write "${profile_path}/background-color" "'#f7f7f7'"
dconf write "${profile_path}/foreground-color" "'#464646'"
dconf write "${profile_path}/bold-color" "'#464646'"
