...
dconf write "${profile_path}/visible-name" "'Mocha (dark) '"
dconf write "${profile_path}/background-color" "'#3b3228'"
dconf write "${profile_path}/foreground-color" "'#d0c8c6'"
dconf write "${profile_path}/bold-color" "'#d0c8c6'"
