...
dconf write "${profile_path}/visible-name" "'Atelierdune (dark) '"
dconf write "${profile_path}/background-color" "'#20201d'"
dconf write "${profile_path}/foreground-color" "'#a6a28c'"
dconf write "${profile_path}/bold-color" "'#a6a28c'"
