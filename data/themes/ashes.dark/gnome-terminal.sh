...
dconf write "${profile_path}/visible-name" "'Ashes (dark) '"
dconf write "${profile_path}/background-color" "'#1c2023'"
dconf write "${profile_path}/foreground-color" "'#c7ccd1'"
dconf write "${profile_path}/bold-color" "'#c7ccd1'"
