...
dconf write "${profile_path}/visible-name" "'Codeschool (dark) '"
dconf write "${profile_path}/background-color" "'#232c31'"
dconf write "${profile_path}/foreground-color" "'#9ea7a6'"
dconf write "${profile_path}/bold-color" "'#9ea7a6'"
