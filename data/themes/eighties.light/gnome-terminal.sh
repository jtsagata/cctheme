...
dconf write "${profile_path}/visible-name" "'Eighties (light) '"
dconf write "${profile_path}/background-color" "'#f2f0ec'"
dconf write "${profile_path}/foreground-color" "'#515151'"
dconf write "${profile_path}/bold-color" "'#515151'"
