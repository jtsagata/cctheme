...
dconf write "${profile_path}/visible-name" "'Atelierlakeside (dark) '"
dconf write "${profile_path}/background-color" "'#161b1d'"
dconf write "${profile_path}/foreground-color" "'#7ea2b4'"
dconf write "${profile_path}/bold-color" "'#7ea2b4'"
