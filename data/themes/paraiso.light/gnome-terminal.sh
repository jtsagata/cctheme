...
dconf write "${profile_path}/visible-name" "'Paraiso (light) '"
dconf write "${profile_path}/background-color" "'#e7e9db'"
dconf write "${profile_path}/foreground-color" "'#4f424c'"
dconf write "${profile_path}/bold-color" "'#4f424c'"
