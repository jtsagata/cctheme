...
dconf write "${profile_path}/visible-name" "'Greenscreen (light) '"
dconf write "${profile_path}/background-color" "'#00ff00'"
dconf write "${profile_path}/foreground-color" "'#005500'"
dconf write "${profile_path}/bold-color" "'#005500'"
