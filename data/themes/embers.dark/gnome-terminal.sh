...
dconf write "${profile_path}/visible-name" "'Embers (dark) '"
dconf write "${profile_path}/background-color" "'#16130f'"
dconf write "${profile_path}/foreground-color" "'#a39a90'"
dconf write "${profile_path}/bold-color" "'#a39a90'"
