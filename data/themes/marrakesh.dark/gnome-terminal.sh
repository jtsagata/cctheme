...
dconf write "${profile_path}/visible-name" "'Marrakesh (dark) '"
dconf write "${profile_path}/background-color" "'#201602'"
dconf write "${profile_path}/foreground-color" "'#948e48'"
dconf write "${profile_path}/bold-color" "'#948e48'"
