...
dconf write "${profile_path}/visible-name" "'Brewer (light) '"
dconf write "${profile_path}/background-color" "'#fcfdfe'"
dconf write "${profile_path}/foreground-color" "'#515253'"
dconf write "${profile_path}/bold-color" "'#515253'"
