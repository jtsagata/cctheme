...
dconf write "${profile_path}/visible-name" "'Atelierseaside (light) '"
dconf write "${profile_path}/background-color" "'#f0fff0'"
dconf write "${profile_path}/foreground-color" "'#5e6e5e'"
dconf write "${profile_path}/bold-color" "'#5e6e5e'"
