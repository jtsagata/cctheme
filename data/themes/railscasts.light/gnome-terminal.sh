...
dconf write "${profile_path}/visible-name" "'Railscasts (light) '"
dconf write "${profile_path}/background-color" "'#f9f7f3'"
dconf write "${profile_path}/foreground-color" "'#3a4055'"
dconf write "${profile_path}/bold-color" "'#3a4055'"
