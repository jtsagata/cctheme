...
dconf write "${profile_path}/visible-name" "'Atelierforest (dark) '"
dconf write "${profile_path}/background-color" "'#1b1918'"
dconf write "${profile_path}/foreground-color" "'#a8a19f'"
dconf write "${profile_path}/bold-color" "'#a8a19f'"
